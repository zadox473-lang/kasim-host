...
async def check_card_with_braintree(card_details: str, user_info: Dict) -> Optional[Dict]:
    ...
    api_url = f"https://autobtree.nikhilkhokhar.com/gate=b3/cc={formatted_card}"
...
def format_response_braintree(result: dict, user_info: dict) -> Tuple[str, str]:
    ...
    if "error" in result:
        ...
        formatted_error = f"""<a href='https://t.me/failedfr'>⚠️</a> <b>𝙀𝙧𝙧𝙤𝙧 𝘿𝙚𝙩𝙚𝙘𝙩𝙚𝙙</b> ⚠️

<a href='https://t.me/failedfr'>💳</a> <b>𝘾𝙖𝙧𝙙:</b> <code>{result.get('card_details', 'Unknown')}</code>

<a href='https://t.me/failedfr'>📝</a> <b>𝙍𝙚𝙖𝙨𝙤𝙣:</b> <i>{error_msg}</i>

<a href='https://t.me/failedfr'>💡</a> <b>𝙏𝙞𝙥:</b> <i>Please check your card details and try again.</i>"""
    ...
    status_part = f"""<pre><a href='https://t.me/failedfr'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ {status_style}</pre>"""
...
{card_part}
<a href='https://t.me/failedfr'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝗕𝗿𝗮𝗶𝗻𝘁𝗿𝗲𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/failedfr'>⊀</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>
{bank_part}
<a href='https://t.me/failedfr'>⌬</a> <b>𝐔𝐬𝐞𝐫</b> ↬ {user_link} 
...
async def handle_chk_command(update, context):
    ...
    if not card_details:
        await update.message.reply_text(
            """<a href='https://t.me/failedfr'>⚠️</a> <b>𝙈𝙞𝙨𝙨𝙞𝙣𝙜 𝘾𝙖𝙧𝙙 𝘿𝙚𝙩𝙖𝙞𝙡𝙨</b>

<a href='https://t.me/failedfr'>📝</a> <b>𝙐𝙨𝙖𝙜𝙚 𝙊𝙥𝙩𝙞𝙤𝙣𝙨:</b>
...
<a href='https://t.me/failedfr'>📊</a> <b>Current Plan:</b> <code>{user_tier}</code>
<a href='https://t.me/failedfr'>💰</a> <b>Credits:</b> <code>0</code>""",
            parse_mode="HTML",
            disable_web_page_preview=True
        )
        return
...
<a href='https://t.me/failedfr'>📝</a> <b>𝘿𝙚𝙩𝙖𝙞𝙡𝙨:</b> <code>An unexpected error occurred</code>

<a href='https://t.me/failedfr'>💡</a> <b>𝙎𝙪𝙜𝙜𝙚𝙨𝙩𝙞𝙤𝙣:</b> <i>Please try again later.</i>"""
...
if __name__ == "__main__":
    ...
    async def test():
        result = await check_card_with_braintree(test_card, test_user)
        formatted, _ = format_response_braintree(result, test_user)
        print(formatted)
